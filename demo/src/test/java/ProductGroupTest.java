...
public class ProductGroupTest {
    ...
    private List<Product> createTestProducts() {
        ...
        products.add(new Product("Product5", "12.50", "USD", "Category1", "9", "Store1", "01.02.2023"));
        products.add(new Product("Product6", "1.50", "USD", "Category2", "15", "Store2", "02.01.2023"));
    ...
    public void testGroupProductsTotalPriceByCategories(){
        ...
        String groupby = "category";
        Map<String, GroupedProduct> groupedProducts = ProductGrouper.groupProductsByField(products, groupby);
        Assert.assertEquals(new BigDecimal(10*8+30*3+12.50*9).setScale(2),  groupedProducts.get("Category1").getTotalPriceSum());
    }
